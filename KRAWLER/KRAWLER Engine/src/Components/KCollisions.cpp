...
bool Krawler::AABBvsAABB(KCollisionDetectionData& data)
{
	KPRINTF("Attempted to do a AABBvsAABB collision detection\n");
	return false;
}

bool Krawler::CirclevsCircle(KCollisionDetectionData& data)
{
	return false;
}

bool Krawler::AABBvsCircle(KCollisionDetectionData& data)
{
	return false;
}
