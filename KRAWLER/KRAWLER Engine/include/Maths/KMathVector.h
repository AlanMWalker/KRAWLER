...
///Return: Vector2
template<typename T>
KRAWLER_API __forceinline sf::Vector2<T> Normalise(const sf::Vector2<T>& Vector);
...
template<typename T>
KRAWLER_API __forceinline T GetLength(const sf::Vector2<T>& Vector);

///Get the squared length of a vector 
///Param: ref Vector2
///Return: Type of vector
template<typename T>
KRAWLER_API __forceinline T GetSquareLength(const sf::Vector2<T>& Vector);

///Set a vector to 0, 0
///Param: ref Vector2
///Return: Vector2
template<typename T>
KRAWLER_API __forceinline void Zero(sf::Vector2<T>& Vector);

///Get angle between two vectors (in radians)
///Param: ref Vector2
///Return: Type of vector
template<typename T>
KRAWLER_API __forceinline T GetAngleBetween(const sf::Vector2<T>& VectorA, const sf::Vector2<T>& VectorB);
...
template<typename T>
KRAWLER_API __forceinline std::ostream& operator<< (std::ostream& OStream, const sf::Vector2<T>& Vector);

///Input stream operator for Vector2
template<typename T>
KRAWLER_API __forceinline std::istream& operator >> (std::istream& IStream, sf::Vector2<T>& Vector);
